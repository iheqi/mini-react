...
describe('ReactElement', () => {
	...
	beforeEach(() => {
		...
		// unpolyfilled environment. 模拟 Symbol 降级
	...
	// test: 浏览器不支持 Symbol 时，$$typeof 回退为 0xeac7
	...
	// test: React.createElement的第二个参数后面的参数
	...
	// test: React.createElement的第二个参数
